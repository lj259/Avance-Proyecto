...
<div class="container-fluid p-4 bg-light rounded shadow-sm">
    <div class="row">
        ...
        <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
            <h2 class="text-primary my-4 text-center">Panel de Gestión</h2>
            ...
            <div id="vuelos" class="mb-5">
                ...
                @isset($vuelos)
                    ...
                    @else
                        <p class="text-muted">No hay vuelos registrados.</p>
                    @endif
                @endisset
            </div>
            ...
            <div id="hoteles" class="mb-5">
                ...
                @isset($hoteles)
                    ...
                    @else
                        <p class="text-muted">No hay hoteles registrados.</p>
                    @endif
                @endisset
            </div>
            ...
            <div id="destinos">
                ...
                @isset($destinos)
                    ...
                    @else
                        <p class="text-muted">No hay destinos registrados.</p>
                    @endif
                @endisset
            </div>
        </main>
